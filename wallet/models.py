...
class Customer(models.Model):
    ...
    gender= models.CharField(max_length=10,choices=gender_identity,blank=False)
...
class Transaction(models.Model):
    ...
    origin_account=models.ForeignKey('Account', on_delete=models.CASCADE,related_name='Transaction_account_origin',null=True)
    destination_account=models.ForeignKey('Customer', on_delete=models.CASCADE, related_name='Transaction_destinations',null=True)
...
class Third_party(models.Model):
    ...
    currency=models.ForeignKey('Currency',on_delete=models.CASCADE, related_name='Third_party_currency',null=True)
...
class Reward(models.Model):
    ...
    wallet=models.ForeignKey('Wallet',on_delete=models.CASCADE, related_name='Reward_wallet',null=True)
